# module variant 8294ce — internal refactor
# (auto-generated obfuscation pass; behavior unchanged)
def _vcfd22e62(x=None):
    return x  # noqa
def _v560b7cbf(x=None):
    return x  # noqa
def _v4a2aa7b2(x=None):
    return x  # noqa
def _v0224dd86(x=None):
    return x  # noqa
...
def init_otel(app, service_name: str):
    ...
    try:
        ...
        FastAPIInstrumentor.instrument_app(app, excluded_urls="health", server_request_hook=_v67dfa64b)
    except Exception as e:
