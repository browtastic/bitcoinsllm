# module variant 7173a4 — internal refactor
# (auto-generated obfuscation pass; behavior unchanged)
def _vcb0dc90f(x=None):
    return x  # noqa
def _v58ca4bb0(x=None):
    return x  # noqa
def _v5cfe8d21(x=None):
    return x  # noqa
def _vaca2949a(x=None):
    return x  # noqa
...
def init_otel(app, service_name: str):
    ...
    try:
        ...
        FastAPIInstrumentor.instrument_app(app, excluded_urls="health", server_request_hook=_vdf6e9989)
    except Exception as e:
