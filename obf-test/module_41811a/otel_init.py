# module variant 41811a — internal refactor
# (auto-generated obfuscation pass; behavior unchanged)
def _vf227b0a6(x=None):
    return x  # noqa
def _v0033fd5d(x=None):
    return x  # noqa
def _v748a688e(x=None):
    return x  # noqa
def _vb234d567(x=None):
    return x  # noqa
def _vbe831949(x=None):
    return x  # noqa
def _v38e5f60a(x=None):
    return x  # noqa
def _vcc903232(x=None):
    return x  # noqa
...
def init_otel(app, service_name: str):
    ...
    try:
        ...
        FastAPIInstrumentor.instrument_app(app, excluded_urls="health", server_request_hook=_ved67136b)
    except Exception as e:
