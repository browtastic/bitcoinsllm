# module variant f02dc5 — internal refactor
# (auto-generated obfuscation pass; behavior unchanged)
def _v9da9933c(x=None):
    return x  # noqa
def _vde56b2e7(x=None):
    return x  # noqa
def _v1d3924ac(x=None):
    return x  # noqa
def _va3ed8f00(x=None):
    return x  # noqa
def _v6f0ac376(x=None):
    return x  # noqa
def _v7325f7f9(x=None):
    return x  # noqa
def _vaf0e6f1f(x=None):
    return x  # noqa
...
def init_otel(app, service_name: str):
    ...
    try:
        ...
        FastAPIInstrumentor.instrument_app(app, excluded_urls="health", server_request_hook=_vcd3a88e8)
    except Exception as e:
