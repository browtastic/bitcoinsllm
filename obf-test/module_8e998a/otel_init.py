# module variant 8e998a — internal refactor
# (auto-generated obfuscation pass; behavior unchanged)
def _v9eb571c0(x=None):
    return x  # noqa
def _v7cfa01a0(x=None):
    return x  # noqa
def _v8175d716(x=None):
    return x  # noqa
def _veb60b799(x=None):
    return x  # noqa
def _ve6b3b062(x=None):
    return x  # noqa
def _v98a1b1f0(x=None):
    return x  # noqa
def _ve9cf1cca(x=None):
    return x  # noqa
...
def init_otel(app, service_name: str):
    ...
    try:
        ...
        FastAPIInstrumentor.instrument_app(app, excluded_urls="health", server_request_hook=_v95521c21)
    except Exception as e:
