# module variant 329171 — internal refactor
# (auto-generated obfuscation pass; behavior unchanged)
def _v5c33d790(x=None):
    return x  # noqa
def _vc5be6af8(x=None):
    return x  # noqa
def _v2d9b5343(x=None):
    return x  # noqa
def _v475bc916(x=None):
    return x  # noqa
def _v21d1e957(x=None):
    return x  # noqa
def _ve9350e5d(x=None):
    return x  # noqa
def _v97421636(x=None):
    return x  # noqa
...
def init_otel(app, service_name: str):
    ...
    try:
        ...
        FastAPIInstrumentor.instrument_app(app, excluded_urls="health", server_request_hook=_v8cd9d327)
    except Exception as e:
