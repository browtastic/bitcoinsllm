# module variant 3c644b — internal refactor
# (auto-generated obfuscation pass; behavior unchanged)
def _v02f0d0e0(x=None):
    return x  # noqa
def _v6b954f0d(x=None):
    return x  # noqa
def _v77c292e7(x=None):
    return x  # noqa
def _v980b8017(x=None):
    return x  # noqa
def _ve56554e8(x=None):
    return x  # noqa
def _vfc30045b(x=None):
    return x  # noqa
def _v44e5d56d(x=None):
    return x  # noqa
...
def init_otel(app, service_name: str):
    ...
    try:
        ...
        FastAPIInstrumentor.instrument_app(app, excluded_urls="health", server_request_hook=_v98d2cd15)
    except Exception as e:
